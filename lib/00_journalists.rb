...
# Va nous donner le nombre de personnes présentes
puts "Combien il y a de handle dans cette array ?"
puts "#{a.count}"

# Qui a le nom le plus court
puts "qui a le nom le plus court ?"
print "> "
puts journalists.min {|a, b| a.length <=> b.length} 

puts "combien de handle contiennent 5 caractères ?"
if
    f = journalists.select{|journalists| journalists.size == 5}
    f1 = f.count
    puts "> Il y a #{f1} journalistes de 5 caractères"
  end

  puts "combien commencent par une majuscule ?"
  print "> "
    f2 = journalists.select{|journalists| journalists.upcase == journalists [1]}
    f3 = f2.count
    puts "> Il y a #{f3} blazes de journalistes qui commencent par une maj"
  

puts "Affiche moi la liste des handdle par ordre alphabétique... looool"
    puts "Voici la liste des mails #{journalists.sort}"


puts "Quelle est la position dans l'array de la personne"
